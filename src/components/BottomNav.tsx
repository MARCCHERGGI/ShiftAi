...
import { FileText, MessageSquare, Home, Search } from "lucide-react";
...
export default function BottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-50 bg-white/90 dark:bg-[#1a1a24]/90 backdrop-blur-lg border-t border-gray-200 dark:border-gray-800"
